...
class TestFeatureFlags:
    ...
    def test_load_from_environment(self, tmp_path, monkeypatch) -> None:
    ...
    def test_backward_compatibility(self, tmp_path, monkeypatch) -> None:
    ...
    def test_is_enabled(self, tmp_path) -> None:
    ...
    def test_get_feature(self, tmp_path) -> None:
    ...
    def test_get_features_by_category(self, tmp_path) -> None:
    ...
    def test_update_feature(self, tmp_path) -> None:
    ...
    def test_env_var_precedence(self, tmp_path, monkeypatch) -> None:
