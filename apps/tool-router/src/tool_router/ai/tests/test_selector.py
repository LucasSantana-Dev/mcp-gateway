...
class TestAIToolSelector:
    ...
    def test_select_tool_success(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_with_extra_text(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_invalid_json(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_nonexistent_tool(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_timeout(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_request_error(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_http_error(self, mock_post, selector, sample_tools) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_model_not_found(self, mock_post, selector, sample_tools) -> None:
    ...
    def test_select_tool_empty_tools(self, selector) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_too_many_tools(self, mock_post, selector) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_select_tool_confidence_out_of_range(self, mock_post, selector, sample_tools) -> None:
    ...
    def test_is_available_success(self, mock_get, selector) -> None:
    ...
    @patch("tool_router.ai.selector.requests.get")
    def test_is_available_failure(self, mock_get, selector) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_pull_model_success(self, mock_post, selector) -> None:
    ...
    @patch("tool_router.ai.selector.requests.post")
    def test_pull_model_failure(self, mock_post, selector) -> None:
