...
class TestHandleListServers:
    ...
    def test_list_servers_success(self, temp_config_file) -> None:
    ...
    def test_list_servers_error_handling(self, monkeypatch) -> None:
        """Test error handling in list servers."""

        def mock_list_error() -> Never:
            msg = "Test error"
...
class TestHandleGetServer:
    ...
    def test_get_existing_server(self, temp_config_file) -> None:
    ...
    def test_get_nonexistent_server(self, temp_config_file) -> None:
    ...
    def test_get_server_error_handling(self, monkeypatch) -> None:
        """Test error handling in get server."""

        def mock_status_error(name) -> Never:
            msg = "Test error"
            raise RuntimeError(msg)
...
class TestHandleUpdateServer:
    ...
    def test_enable_server_success(self, temp_config_file) -> None:
    ...
    def test_disable_server_success(self, temp_config_file) -> None:
    ...
    def test_update_nonexistent_server(self, temp_config_file) -> None:
    ...
    def test_update_missing_enabled_field(self, temp_config_file) -> None:
    ...
    def test_update_invalid_enabled_type(self, temp_config_file) -> None:
    ...
    def test_update_server_error_handling(self, monkeypatch) -> None:
        """Test error handling in update server."""

        def mock_enable_error(name) -> Never:
            msg = "Test error"
            raise RuntimeError(msg)
...
class TestFastAPIIntegration:
    ...
    def test_fastapi_update_server(self, temp_config_file) -> None:
        ...
        response = client.patch(
            "/api/virtual-servers/cursor-default",
            json={"enabled": False}
        )
        assert response.status_code == 200
        data = response.json()
