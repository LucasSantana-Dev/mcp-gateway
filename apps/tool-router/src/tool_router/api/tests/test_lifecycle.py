...
class TestParseServerLine:
    ...
    def test_parse_valid_line_with_enabled_true(self) -> None:
    ...
    def test_parse_valid_line_with_enabled_false(self) -> None:
    ...
    def test_parse_valid_line_without_enabled_flag(self) -> None:
...
class TestListVirtualServers:
    ...
    def test_list_servers_file_not_found(self, monkeypatch) -> None:
...
class TestGetServerStatus:
    ...
    def test_get_status_existing_server(self, temp_config_file) -> None:
    ...
    def test_get_status_nonexistent_server(self, temp_config_file) -> None:
...
class TestEnableDisableServer:
    ...
    def test_enable_disabled_server(self, temp_config_file) -> None:
    ...
    def test_disable_enabled_server(self, temp_config_file) -> None:
    ...
    def test_enable_nonexistent_server(self, temp_config_file) -> None:
    ...
    def test_disable_nonexistent_server(self, temp_config_file) -> None:
    ...
    def test_backup_created_on_update(self, temp_config_file) -> None:
