...
from ..training.training_pipeline import TrainingPipeline, DEFAULT_TRAINING_SOURCES
...
class TrainingManagerTool:
    ...
    def start_training_run(
        ...
        try:
            ...
            return {
                "error": str(e),
                "message": "Failed to start training run"
            }
    ...
    def get_training_configuration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": str(e),
                "message": "Failed to get training configuration"
            }
...
def training_manager_handler(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "error": str(e),
            "message": "Training manager operation failed"
        }
