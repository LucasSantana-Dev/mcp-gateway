...
class TestListFeatures:
    ...
    def test_list_features_by_category(self, client):
    ...
    def test_list_features_invalid_category(self, client):
...
class TestUpdateFeature:
    ...
    def test_update_feature_enable(self, client):
    ...
    def test_update_feature_disable(self, client):
    ...
    def test_update_nonexistent_feature(self, client):
    ...
    def test_update_feature_missing_enabled_field(self, client):
    ...
    def test_update_feature_invalid_json(self, client):
    ...
    def test_update_feature_invalid_enabled_type(self, client):
...
class TestReloadFeatures:
    ...
    def test_reload_features_success(self, client, temp_features_config):
    ...
    def test_reload_features_missing_file(self, client):
...
class TestFeatureIntegration:
    ...
    def test_full_feature_lifecycle(self, client):
        """Test complete feature lifecycle: list, get, update, reload."""
        # 1. List all features
        response = client.get("/api/features")
        assert response.status_code == 200
        initial_features = json.loads(response.data)["features"]
