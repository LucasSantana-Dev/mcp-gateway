...
class EnhancedRateLimiter:
    ...
    def __init__(self, use_redis: bool = False, redis_url: Optional[str] = None, config: Optional[RateLimitConfig] = None):
    ...
    def check_rate_limit(self, identifier: str, config: Optional[RateLimitConfig] = None) -> RateLimitResult:
